...
| Crash logs/analytics | No Crashlytics, Sentry, Segment, GA, or Firebase Analytics SDK found in package.json | Not confirmed in repo | Not applicable from code | Not confirmed | Not confirmed | NEEDS OWNER CONFIRMATION for App Store Connect |
...
| Google Sign-In | `@react-native-google-signin/google-signin` | Google OAuth profile/email depending consent | Native Firebase/OAuth config currently mismatched and must be regenerated |
